                    ...
                    <div className="mb-8 flex flex-col md:flex-row gap-4">
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className="input text-gray-900 input-bordered w-full pl-10 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all bg-white shadow-sm"
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                            />
                        </div>
                        <select 
                            className="select select-bordered w-full md:w-64 bg-white text-gray-900 shadow-sm focus:ring-2 focus:ring-purple-500 transition-all"
                                    ...
                                    <div className="card bg-white shadow-lg hover:shadow-2xl transition-all duration-300 h-full border border-gray-200 hover:border-blue-500 hover:-translate-y-2 overflow-hidden">
                                        ...
                                        <div className="card-body relative z-10">
                                            <div className="flex items-start justify-between mb-2">
                                                <h2 className="card-title text-lg text-gray-900 group-hover:text-blue-600 transition font-bold">
                                            ...
                                            {prompt.category && (
                                                <div className="badge bg-blue-100 text-blue-800 border-blue-300 mb-3 border-2 group-hover:bg-blue-200 group-hover:border-blue-500 transition-all font-semibold">
                                                    {prompt.category}
                                                </div>
                                            )}
